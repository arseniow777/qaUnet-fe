            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  href={item.href}
                  key={item.title}
                  className="flex h-10 w-10 items-center justify-center rounded-sm bg-yellow-500"
                >
  ...
  return (
    <a href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-xs bg-yellow-500 border border-neutral-900"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
